...
public class Writer_Reporter {
	...
	public void Test_001_Login(int j) throws Exception {
		Mthead.logger
				.info("*********************************************************************");
		myYaml = new YamlUtil(Login.driver, System.getProperty("user.dir") + File.separator +"/src/test/java/W_Reporter.yaml");
